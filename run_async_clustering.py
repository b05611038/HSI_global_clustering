...
from hsi_global_clustering import (
    JSONMATDataset,
...
def main():
    ...
    model_kwargs['encoder_kwargs']['embed_dim'] = args.embed_dim
    model_kwargs['mean_shift_kwargs'].update({
        'embed_dim': args.embed_dim,
        'n_clusters': args.n_clusters,
        'num_iters': args.num_iters,
    })
    model_kwargs['loss_weights'] = {
        'orth': args.coef_orth,
        'bal': args.coef_bal,
        'unif': args.coef_unif,
        'cons': args.coef_cons,
    ...
    optimizer_kwargs = deepcopy(DEFAULT_OPTIMIZER_KWARGS)
    optimizer_kwargs.update({'lr': args.lr, 'betas': (args.beta1, args.beta2), 'weight_decay': args.wd})
